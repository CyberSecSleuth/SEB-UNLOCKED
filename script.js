...
const FilterController = {
    ...
    saveFilters() {
        localStorage.setItem('activeFilters', JSON.stringify(Array.from(this.activeFilters)));
    },

    loadSavedFilters() {
        const saved = localStorage.getItem('activeFilters');
        if (saved) {
            this.activeFilters = new Set(JSON.parse(saved));
            this.activeFilters.forEach(genre => {
...
function showGameDetails(gameId) {
    ...
    reqList.innerHTML = `
        <div class="system-requirements">
            <div class="spec-item">
                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="processor">
                <g id="_icons" fill="#ffffff" class="color000000 svgShape">
                    <path d="M15.7432,9.9238c-0.2061-0.8232-0.8447-1.4619-1.6616-1.665c-0.3706-0.0947-0.7476-0.1621-1.104-0.2002
                        c-0.6479-0.0781-1.3062-0.0791-1.939-0.001c-0.3726,0.0391-0.7495,0.1064-1.1147,0.1992c-0.8223,0.2051-1.4609,0.8438-1.666,1.6631
                        c-0.0938,0.3691-0.1611,0.7451-0.1997,1.1045C8.0195,11.3506,8,11.6729,8,12s0.0195,0.6494,0.0571,0.9639
                        c0.0396,0.3711,0.1069,0.7471,0.1997,1.1123c0.2061,0.8232,0.8447,1.4619,1.6616,1.665c0.3706,0.0947,0.7476,0.1621,1.1064,0.2002
                        C11.3516,15.9805,11.6733,16,12,16s0.6484-0.0195,0.9614-0.0576c0.3726-0.0391,0.7495-0.1064,1.1147-0.1992
                        c0.8223-0.2051,1.4609-0.8438,1.666-1.6631c0.0938-0.3691,0.1611-0.7451,0.1997-1.1045C15.9805,12.6494,16,12.3271,16,12
                        s-0.0195-0.6494-0.0571-0.9639C15.9033,10.665,15.8359,10.2891,15.7432,9.9238z M13.9546,12.751
                        c-0.0298,0.2783-0.0806,0.5596-0.1519,0.8408c-0.0259,0.1035-0.1064,0.1846-0.2153,0.2119
                        c-0.2769,0.0703-0.5581,0.1211-0.8486,0.1514c-0.4951,0.0586-0.9688,0.0596-1.4912-0.001
                        c-0.2769-0.0293-0.5581-0.0801-0.8403-0.1523c-0.1035-0.0254-0.1841-0.1064-0.2109-0.2139
                        c-0.0703-0.2773-0.1211-0.5586-0.1519-0.8486C10.0146,12.4912,10,12.2471,10,12s0.0146-0.4912,0.0454-0.751
                        c0.0298-0.2783,0.0806-0.5596,0.1519-0.8408c0.0259-0.1035,0.1064-0.1846,0.2153-0.2119c0.2769-0.0703,0.5581-0.1211,0.8511-0.1514
                        C11.5063,10.0146,11.7505,10,11.9966,10c0.2495,0,0.5015,0.0156,0.7559,0.0459c0.2769,0.0293,0.5581,0.0801,0.8403,0.1523
                        c0.1035,0.0254,0.1841,0.1064,0.2109,0.2139c0.0703,0.2773,0.1211,0.5586,0.1519,0.8486C13.9854,11.5088,14,11.7529,14,12
                        S13.9854,12.4912,13.9546,12.751z" fill="#ffffff" class="color000000 svgShape"></path>
                    <path d="M22,10c0-0.5527-0.4478-1-1-1h-1.2533c-0.0817-0.5089-0.1785-1.0182-0.3068-1.5225
                        c-0.3594-1.4404-1.4771-2.5576-2.9136-2.917c-0.509-0.129-1.0192-0.226-1.5264-0.3075V3c0-0.5527-0.4478-1-1-1s-1,0.4473-1,1v1.03
                        c-0.6673-0.0375-1.3358-0.0378-2-0.0002V3c0-0.5527-0.4478-1-1-1S9,2.4473,9,3v1.2534C8.4913,4.335,7.9822,4.4316,7.4775,4.5596
                        C6.0371,4.9199,4.9194,6.0371,4.561,7.4736C4.4317,7.9822,4.3347,8.4927,4.2531,9H3c-0.5522,0-1,0.4473-1,1s0.4478,1,1,1h1.0297
                        C4.0109,11.3324,4,11.6642,4,12c0,0.3364,0.0109,0.6686,0.0296,1H3c-0.5522,0-1,0.4473-1,1s0.4478,1,1,1h1.2533
                        c0.0817,0.5089,0.1785,1.0182,0.3068,1.5225c0.3594,1.4404,1.4771,2.5576,2.9136,2.917c0.5089,0.129,1.0191,0.226,1.5264,0.3074V21
                        c0,0.5527,0.4478,1,1,1s1-0.4473,1-1v-1.0299C11.3325,19.989,11.6644,20,12,20c0.3362,0,0.6685-0.011,1-0.0298V21
                        c0,0.5527,0.4478,1,1,1s1-0.4473,1-1v-1.2534c0.5087-0.0815,1.0178-0.1782,1.5225-0.3062
                        c1.4404-0.3604,2.5581-1.4775,2.9165-2.9141c0.1293-0.5086,0.2264-1.019,0.3079-1.5264H21c0.5522,0,1-0.4473,1-1s-0.4478-1-1-1
                        h-1.0297C19.9891,12.6676,20,12.3358,20,12c0-0.3364-0.0109-0.6686-0.0296-1H21C21.5522,11,22,10.5527,22,10z M16.0342,17.5
                        c-0.7124,0.1816-1.4321,0.3105-2.1528,0.3867c-1.2725,0.1523-2.4766,0.1533-3.7764-0.001
                        c-0.707-0.0752-1.4268-0.2041-2.1431-0.3867c-0.7212-0.1797-1.2812-0.7393-1.4624-1.4648
                        c-0.1807-0.7129-0.3105-1.4326-0.3862-2.1533C6.0371,13.2451,6,12.6299,6,12s0.0371-1.2451,0.1147-1.8955
                        C6.189,9.3984,6.3188,8.6787,6.5005,7.9619C6.6807,7.2402,7.2407,6.6807,7.9658,6.5c0.7124-0.1816,1.4321-0.3105,2.1538-0.3867
                        C10.7417,6.0381,11.3682,6,11.9966,6c0.6318,0,1.2656,0.0381,1.8984,0.1143c0.707,0.0752,1.4268,0.2041,2.1431,0.3867
                        c0.7212,0.1797,1.2812,0.7393,1.4624,1.4648c0.1807,0.7129,0.3105,1.4326,0.3862,2.1533C17.9629,10.7549,18,11.3701,18,12
                        s-0.0371,1.2451-0.1147,1.8955c-0.0742,0.7061-0.2041,1.4258-0.3857,2.1426C17.3193,16.7598,16.7593,17.3193,16.0342,17.5z" fill="#ffffff" class="color000000 svgShape"></path>
                </g>
                </svg>
                <div class="spec-details">
                    <span class="spec-title">CPU</span>
                    <span class="spec-value">${currentGame.requirements.cpu}</span>
                </div>
            </div>

            <div class="spec-item">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 80" id="Storage">
                    <path id="Storage" d="M122 154h56a12 12 0 0 0 0-24h-56a12 12 0 0 0 0 24zm0-20h56a8 8 0 0 1 0 16h-56a8 8 0 0 1 0-16zm-.2 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm8 0a2 2 0 0 0 0-4 2 2 0 0 0 0 4zm8 0a2 2 0 0 0 0-4 2 2 0 0 0 0 4zm40.2 14h-56a12 12 0 0 0 0 24h56a12 12 0 0 0 0-24zm0 20h-56a8 8 0 0 1 0-16h56a8 8 0 0 1 0 16zm-56.2-10a2 2 0 0 0 0 4 2 2 0 1 0 0-4zm8 0a2 2 0 0 0 0 4 2 2 0 0 0 0-4zm8 0a2 2 0 0 0 0 4 2 2 0 0 0 0-4zm40.2 18h-56a12 12 0 0 0 0 24h56a12 12 0 0 0 0-24zm0 20h-56a8 8 0 0 1 0-16h56a8 8 0 0 1 0 16zm-56.2-10a2 2 0 0 0 0 4 2 2 0 1 0 0-4zm8 0a2 2 0 0 0 0 4 2 2 0 0 0 0-4zm8 0a2 2 0 0 0 0 4 2 2 0 0 0 0-4z" transform="translate(-110 -130)" fill="#ffffff" fill-rule="evenodd" class="color3f4662 svgShape"></path>
                </svg>
                <div class="spec-details">
                    <span class="spec-title">RAM</span>
                    <span class="spec-value">${currentGame.requirements.ram}</span>
                </div>
            </div>

            <div class="spec-item">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 8.467 8.467" id="Gpu">
                    <path d="M67.986 120.982a1 1 0 0 0-.101.006 1 1 0 0 0-.887 1.012v1.498H65.5a1.001 1.001 0 0 0 0 2.002h1.498v1.498a1 1 0 1 0 2 0V125.5h1.498a1.001 1.001 0 0 0 0-2.002h-1.498V122a1 1 0 0 0-1.012-1.018zm9 0a1 1 0 0 0-.103.006 1 1 0 0 0-.887 1.012v1.498h-1.498a1.001 1.001 0 0 0 0 2.002h1.498v1.498a1 1 0 1 0 2 0V125.5h1.508a1.001 1.001 0 0 0 0-2.002h-1.508V122a1 1 0 0 0-1.01-1.018zm-15 3.502a1 1 0 0 0-.99 1.02v20.994a1.001 1.001 0 1 0 2.002 0v-2.002h2v2.002a1 1 0 0 0 1.004 1.004H75a1 1 0 0 0 .996-1.004v-2.002h13.008c1.09 0 1.992-.901 1.992-1.992V130.5c0-1.09-.901-2-1.992-2H62.998v-2.996a1 1 0 0 0-1.012-1.02zm6.817 7.024a1 1 0 0 0-.573 1.635c.452.54.72 1.004.76 1.322.024.184.004.38-.136.637-.71-.461-1.454-.669-2.15-.579-.988.128-1.72.686-2.349 1.211a1.001 1.001 0 0 0-.343.594c.09-2.604 2.19-4.718 4.79-4.82zm.373 0c2.668.095 4.828 2.304 4.828 4.994 0 2.75-2.256 4.998-5.006 4.998-2.693 0-4.896-2.158-4.986-4.83a1.001 1.001 0 0 0 1.629.6c.54-.452 1.002-.72 1.32-.76.185-.024.384-.002.643.14-.463.71-.674 1.45-.584 2.147.127.987.685 1.719 1.21 2.348a1 1 0 0 0 1.536-1.284c-.452-.54-.72-1.004-.76-1.322-.025-.192.002-.4.164-.674.714.484 1.462.701 2.168.608.978-.13 1.684-.684 2.305-1.203a1.001 1.001 0 0 0-1.286-1.536c-.547.458-.996.722-1.285.76-.178.024-.377-.002-.654-.172.446-.699.647-1.429.559-2.115-.128-.987-.686-1.72-1.211-2.348a1 1 0 0 0-.59-.351zm13.66 0a1 1 0 0 0-.572 1.635c.451.54.718 1.004.76 1.322.023.184.001.38-.141.637-.709-.46-1.45-.669-2.147-.579-.987.128-1.719.686-2.347 1.211a1 1 0 0 0-.35.53 5.017 5.017 0 0 1 4.797-4.756zm.373 0a5.011 5.011 0 0 1 4.805 4.678 1 1 0 0 0-1.623-.452c-.548.458-.997.722-1.286.76-.179.024-.38-.002-.66-.176.447-.698.653-1.426.565-2.111-.128-.987-.685-1.72-1.211-2.348a1 1 0 0 0-.59-.351zM69 135.5c.546 0 1 .454 1 1s-.454.996-1 .996-.996-.45-.996-.996.45-1 .996-1zm14.031 0c.546 0 1 .454 1 1s-.454.996-1 .996-.998-.45-.998-.996.452-1 .998-1zm-2.037 1.01c.184-.024.382-.004.639.136-.462.71-.67 1.453-.58 2.15.127.988.685 1.72 1.21 2.349a1 1 0 0 0 1.536-1.284c-.452-.54-.719-1.004-.76-1.322-.025-.192 0-.398.158-.672.714.483 1.46.7 2.166.606.978-.13 1.69-.684 2.31-1.203a1 1 0 0 0 .343-.502c-.14 2.626-2.325 4.732-4.985 4.732-2.652 0-4.838-2.093-4.99-4.709a1 1 0 0 0 1.63.479c.54-.452 1.005-.72 1.323-.76z" color="#000" font-family="sans-serif" font-weight="400" overflow="visible" style="line-height:normal;font-variant-ligatures:normal;font-variant-position:normal;font-variant-caps:normal;font-variant-numeric:normal;font-variant-alternates:normal;font-feature-settings:normal;text-indent:0;text-align:start;text-decoration-line:none;text-decoration-style:solid;text-decoration-color:#000;text-transform:none;text-orientation:mixed;shape-padding:0;isolation:auto;mix-blend-mode:normal" transform="translate(-14.533 -28.917)scale(.24694)" fill="#ffffff" class="color000000 svgShape"></path>
                </svg>
                <div class="spec-details">
                    <span class="spec-title">GPU</span>
                    <span class="spec-value">${currentGame.requirements.gpu}</span>
                </div>
            </div>
        </div>
    `;
    const storageList = document.getElementById('popupStorage');
    storageList.innerHTML = `
    <div class="system-requirements">
            <div class="spec-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" version="1.2" id="folder">
                    <path d="M22.3 8h-2.4c-.4-1.2-1.5-2-2.8-2h-6c0-1.1-.9-2-2-2H5C3.3 4 2 5.3 2 7v10c0 1.7 1.3 3 3 3h12c1.7 0 3.4-1.3 3.8-3L23 9c.1-.6-.2-1-.7-1zM4 9V7c0-.6.4-1 1-1h4c0 1.1.9 2 2 2h6c.6 0 1 .4 1 1H6.9c-.6 0-1.1.4-1.3 1L4 16.3V9zm14.9 7.5c-.2.8-1.1 1.5-1.9 1.5H5s-.4-.2-.2-.8l1.9-7c0-.1.2-.2.3-.2h13.7l-1.8 6.5z"></path>
                </svg>
                <div class="spec-details">
                    <span class="spec-title">Storage</span>
                    <span class="spec-value">${currentGame.requirements.storage}</span>
                </div>
    `;
    // Set up slideshow
    slideshow.innerHTML = '';
